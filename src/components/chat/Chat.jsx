        ...
        <>
            <section className="nes-container">
                <section className="message-list">
                    {chatState.chats.map((message, i) => <Message {...message}
                                                                  direction={chatState.username === message.username ? 'right' : 'left'}
                                                                  key={i}/>)}
                </section>
            </section>
            <form onSubmit={handleSubmit}>
                <div className="nes-field">
                    ...
                    <input type="text" id="message_field" className="nes-input" onChange={handleChange} name="text" value={chatState.text} />
                </div>
            </form>
        </>
    )
